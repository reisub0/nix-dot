# Generated by Powerlevel10k configuration wizard on 2022-05-12 at 21:41 CEST.
...
# 24h time, vertical separators, slanted heads, sharp tails, 2 lines, dotted, no frame,
# sparse, few icons, fluent, transient_prompt, instant_prompt=auto-quiet.
